...
struct ctl_table
{
	...
	struct ctl_table *child;	/* Deprecated 不建议使用这个字段，弃用 */
	proc_handler *proc_handler; /* Callback for text formatting 回调函数, 整型内核变量设置为"&proc_dointvec", 字符串内核变量设置为"&proc_dostring" */
